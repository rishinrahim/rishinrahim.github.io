...
GitHub Pages are public webpages hosted and published through GitHub. To create a github page, please refer this [page](https://docs.github.com/en/pages/quickstart)
...
I'm really happy with how `Next.js` has turned out so far and excited about the possibilities it brings to my site. I'm looking forward to adding features like page reactions, a comments section, Google Analytics, and more. Let's see where this journey takes us!

You can check out the codebase [here](https://github.com/rishinrahim/rishinrahim.github.io). Anyone can clone this repository and make changes to host a personal blog of their own.
